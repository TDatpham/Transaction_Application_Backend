...
public class AccountControllerTests extends BaseTest {
    ...
    public void test_pin_check_without_pin() throws Exception {
        Map<String, String> userDetails = (Map<String, String>) createAndLoginUser();
    ...
    public void test_pin_create_with_invalid_password() throws Exception {
        ...
        PinRequest pinRequest = new PinRequest(userDetails.get("accountNumber"), 
    ...
    public void test_pin_create_unauthorized_access() throws Exception {
        PinRequest pinRequest = new PinRequest(getRandomAccountNumber(), 
                getRandomPin(), getRandomPassword());
    ...
    public void test_pin_update_with_valid_data() throws Exception {
        ...
        PinUpdateRequest pinUpdateRequest = new PinUpdateRequest(userDetails.get("accountNumber"), 
                userDetails.get("pin"), getRandomPin(), userDetails.get("password"));
    ...
    public void test_pin_update_with_invalid_password() throws Exception {
        ...
        PinUpdateRequest pinUpdateRequest = new PinUpdateRequest(userDetails.get("accountNumber"), 
                userDetails.get("pin"), getRandomPin(), getRandomPassword());
    ...
    public void test_pin_update_with_invalid_old_pin() throws Exception {
        ...
        PinUpdateRequest pinUpdateRequest = new PinUpdateRequest(userDetails.get("accountNumber"), 
                getRandomPin(), getRandomPin(), userDetails.get("password"));
    ...
    public void test_pin_update_with_invalid_new_short_pin() throws Exception {
        ...
        PinUpdateRequest pinUpdateRequest = new PinUpdateRequest(userDetails.get("accountNumber"), 
                userDetails.get("pin"), faker.number().digits(3), userDetails.get("password"));
    ...
    public void test_pin_update_with_invalid_new_long_pin() throws Exception {
        ...
        PinUpdateRequest pinUpdateRequest = new PinUpdateRequest(userDetails.get("accountNumber"), 
                userDetails.get("pin"), faker.number().digits(5), userDetails.get("password"));
    ...
    public void test_pin_update_with_missing_password() throws Exception {
        ...
        PinUpdateRequest pinUpdateRequest = new PinUpdateRequest(userDetails.get("accountNumber"), 
                userDetails.get("pin"), getRandomPin(), null);
    ...
    public void test_pin_update_with_missing_old_pin() throws Exception {
        ...
        PinUpdateRequest pinUpdateRequest = new PinUpdateRequest(userDetails.get("accountNumber"), 
                null, getRandomPin(), userDetails.get("password"));
    ...
    public void test_pin_update_with_missing_new_pin() throws Exception {
        ...
        PinUpdateRequest pinUpdateRequest = new PinUpdateRequest(userDetails.get("accountNumber"), 
                userDetails.get("pin"), null, userDetails.get("password"));
    ...
    public void test_pin_update_with_unauthorized_access() throws Exception {
        PinUpdateRequest pinUpdateRequest = new PinUpdateRequest(getRandomAccountNumber(), 
                getRandomPin(), getRandomPin(), getRandomPassword());
    ...
    public void test_deposit_with_invalid_pin() throws Exception {
        ...
        AmountRequest amountRequest = new AmountRequest(userDetails.get("accountNumber"), 
                getRandomPin(), 100.0);
    ...
    public void test_deposit_with_unauthorized_access() throws Exception {
        AmountRequest amountRequest = new AmountRequest(getRandomAccountNumber(), 
                getRandomPin(), 100.0);
    ...
    public void test_withdraw_with_valid_pin_and_amount() throws Exception {
        double amount = 100.0;
        Map<String, String> userDetails = createAndLoginUserWithInitialBalance(amount);

        AmountRequest amountRequest = new AmountRequest(userDetails.get("accountNumber"), 
                userDetails.get("pin"), amount);
    ...
    public void test_fund_transfer_with_valid_data() throws Exception {
        ...
        Map<String, String> targetUserDetails = (Map<String, String>) createAndLoginUser();

        FundTransferRequest fundTransferRequest = new FundTransferRequest(userDetails.get("accountNumber"),
                targetUserDetails.get("accountNumber"), amount, userDetails.get("pin"));
    ...
    public void test_fund_transfer_with_invalid_source_account_pin() throws Exception {
        ...
        FundTransferRequest fundTransferRequest = new FundTransferRequest(userDetails.get("accountNumber"),
                targetUserDetails.get("accountNumber"), amount, getRandomPin());
    ...
    public void test_fund_transfer_with_invalid_target_account() throws Exception {
        ...
        FundTransferRequest fundTransferRequest = new FundTransferRequest(userDetails.get("accountNumber"), 
                getRandomAccountNumber(), amount, userDetails.get("pin"));
    ...
    public void test_fund_transfer_with_insufficient_funds() throws Exception {
        ...
        FundTransferRequest fundTransferRequest = new FundTransferRequest(userDetails.get("accountNumber"),
                targetUserDetails.get("accountNumber"), amount * 2, userDetails.get("pin"));
    ...
    public void test_fund_transfer_with_zero_amount() throws Exception {
        ...
        FundTransferRequest fundTransferRequest = new FundTransferRequest(userDetails.get("accountNumber"),
                targetUserDetails.get("accountNumber"), 0.0, userDetails.get("pin"));
    ...
    public void test_fund_transfer_with_missing_source_account_pin() throws Exception {
        ...
        FundTransferRequest fundTransferRequest = new FundTransferRequest(userDetails.get("accountNumber"),
                targetUserDetails.get("accountNumber"), amount, null);
    ...
    public void test_fund_transfer_with_missing_target_account() throws Exception {
        ...
        FundTransferRequest fundTransferRequest = new FundTransferRequest(userDetails.get("accountNumber"), 
                null, amount, userDetails.get("pin"));
