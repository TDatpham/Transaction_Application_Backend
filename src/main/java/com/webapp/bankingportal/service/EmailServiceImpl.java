...
public class EmailServiceImpl implements EmailService {
    ...
    public void sendEmailWithAttachment(String to, String subject, String text, String attachmentFilePath) {
        log.info("Sending email with attachment to: {}, subject: {}", to, subject);
        try {
            MimeMessage message = mailSender.createMimeMessage();
            MimeMessageHelper helper = new MimeMessageHelper(message, true);
            helper.setTo(to);
            ...
            helper.addAttachment(attachmentFile.getName(), (DataSource) attachmentFile);
	...
	@Override
	public CompletableFuture<Boolean> sendLoginNotificationEmail(String email, String loginTime, String location) {
